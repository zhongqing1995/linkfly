<template lang="html">
  <div class="ms-organization-wrap" :style="customStyle" v-if="organization.length">
    <div class="ms-organization-title" @click="toggleChild">
      ...
      <span v-show="(selectedItems.length >0 )">{{selectedItems | filterContent}}</span>
    </div>
    <div class="ms-organization-body" v-show="visible" :style="customStyle">
      ...
      <!--</div>-->
      <div class="ms-organization-router" v-if="organizationNavs.length" style="margin-top: 10px">
        <span>已选择:</span>
